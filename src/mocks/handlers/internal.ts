    ...
    return HttpResponse.json({
      items: [
        ...
        },
        {
          id: 2,
          series_id: 1,
          stream_date: DateTime.now().minus({ days: 7 }).toISODate(),
          title: 'Coding on Sundays - Week 2',
          video_clip_count: 0,
        ...
        },
        {
          id: 3,
          series_id: 1,
          stream_date: DateTime.now().minus({ days: 14 }).toISODate(),
          title: 'Coding on Sundays - Week 3',
          video_clip_count: 1,
          has_transcription: true,
          has_silence_detection: true,
          has_episodes: true,
